...
func (r *reconciler) Reconcile(ctx context.Context, rt controller.Runtime, req controller.Request) error {
	...
	exportedServices, err := resource.ListDecodedResource[*pbmulticluster.ExportedServices](ctx, rt.Client, &pbresource.POCListRequest{Request: &pbresource.POCListRequest_FilterByType{FilterByType: &pbresource.POCListRequest_ListByTypeRequest{
	...
	namespaceExportedServices, err := resource.ListDecodedResource[*pbmulticluster.NamespaceExportedServices](ctx, rt.Client, &pbresource.POCListRequest{Request: &pbresource.POCListRequest_FilterByType{FilterByType: &pbresource.POCListRequest_ListByTypeRequest{
		Tenancy: &pbresource.Tenancy{
			Namespace: storage.Wildcard,
			Partition: req.ID.Tenancy.Partition,
			PeerName:  resource.DefaultPeerName,
	...
	partitionedExportedServices, err := resource.ListDecodedResource[*pbmulticluster.PartitionExportedServices](ctx, rt.Client, &pbresource.POCListRequest{Request: &pbresource.POCListRequest_FilterByType{FilterByType: &pbresource.POCListRequest_ListByTypeRequest{
		Tenancy: &pbresource.Tenancy{
			Partition: req.ID.Tenancy.Partition,
			PeerName:  resource.DefaultPeerName,
		},
	...
	services, err := resource.ListDecodedResource[*pbcatalog.Service](ctx, rt.Client, &pbresource.POCListRequest{Request: &pbresource.POCListRequest_FilterByType{FilterByType: &pbresource.POCListRequest_ListByTypeRequest{
		Tenancy: &pbresource.Tenancy{
			Namespace: namespace,
			Partition: req.ID.Tenancy.Partition,
			PeerName:  resource.DefaultPeerName,
