...
func TestReconcile_ResourceWithNoChildren(t *testing.T) {
	...
	runReaperTestCaseWithTenancies(func(tenancy *pbresource.Tenancy) {
		...
		// Retrieve tombstone
		listRsp, err := client.POCList(ctx, &pbresource.POCListRequest{Request: &pbresource.POCListRequest_FilterByType{FilterByType: &pbresource.POCListRequest_ListByTypeRequest{
