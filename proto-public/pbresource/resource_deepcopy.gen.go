...
// DeepCopyInto supports using POCListRequest_ListByTenancyRequest within kubernetes types, where deepcopy-gen is used.
func (in *POCListRequest_ListByTenancyRequest) DeepCopyInto(out *POCListRequest_ListByTenancyRequest) {
	proto.Reset(out)
	proto.Merge(out, proto.Clone(in))
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new POCListRequest_ListByTenancyRequest. Required by controller-gen.
func (in *POCListRequest_ListByTenancyRequest) DeepCopy() *POCListRequest_ListByTenancyRequest {
	if in == nil {
		return nil
	}
	out := new(POCListRequest_ListByTenancyRequest)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyInterface is an autogenerated deepcopy function, copying the receiver, creating a new POCListRequest_ListByTenancyRequest. Required by controller-gen.
func (in *POCListRequest_ListByTenancyRequest) DeepCopyInterface() interface{} {
	return in.DeepCopy()
}
